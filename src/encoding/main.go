...
func demoXml() {
    ...
    emp := &Employee{Id:"12345",Name:"Michael",Email:"michael@email.com",
                     Country: EmployeeCountry{CountryCode:"DE",CountryName:"China"}}
    ...
    var newEmp Employee
    str := `<employee><id>555</id><name>Lee</name><email>lee@email.com</email><country code="DE">China</country></employee>`
...
func demoCsv() {
    ...
    fmt.Println(">>>>read a csv file anad load to array of strut...")
